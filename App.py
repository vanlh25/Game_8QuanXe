...
from GameFrame import GameFrame  # lớp game riêng
...
class App:
    def __init__(self):
        ...
        # nút Start
        self.start_button = pygame.Rect(440, 300, 200, 60)
    ...
    def draw(self):
        if self.state == "MENU":
            ...
            self.font_big.render_to(self.screen, (270, 150), text1, (165, 42, 42))

            text2 = "Ready to play?"
            self.font_small.render_to(self.screen, (460, 230), text2, (165, 42, 42))
            ...
            text_surf, text_rect = self.font_small.render("Start!", (165, 42, 42))
